package io.camunda.example.docxpdf;
...
import io.camunda.example.worker.PdfGeneratorWorker;
...
public class DocxPdfUtils {
	...
	public static void generateDocx(String templateFileName, String targetFileName, Map<String, Object> variables)
		...
		InputStream in = PdfGeneratorWorker.class.getClassLoader().getResourceAsStream(templateFileName);
